...
The adapter includes generic Water registry entries for every shadcn/ui catalog
...
keep tighter prop validation and Water runtime behavior.
...
```ts
import { createShadcnRegistryIndex, defineShadcnRegistryItem } from "@water-ui/adapter-shadcn";
...
```ts
import { createShadcnAdapterConfig, resolveShadcnRegistryTarget } from "@water-ui/adapter-shadcn";
